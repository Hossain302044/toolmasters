                        ...
                        <div className='w-full flex justify-between items-center flex-wrap'>
                            <div>
                                <div class="stat">
                                    ...
                                    <div class="stat-value text-center text-5xl">250+</div>
                                    <div class="stat-desc text-center text-2xl text-primary">Complete Order</div>
                                </div>
                            </div>
                            <div>
                                <div class="stat">
                                    ...
                                    <div class="stat-value text-center text-5xl">10</div>
                                    <div class="stat-desc text-center text-2xl text-primary">Awards</div>
                                </div>
                            </div>
                            <div>
                                <div class="stat">
                                    ...
                                    <div class="stat-value text-center text-5xl">350+</div>
                                    <div class="stat-desc text-center text-2xl text-primary">Happy Clients</div>
                                </div>
                            </div>
                            <div>
                                <div class="stat">
                                    ...
                                    <div class="stat-value text-center text-5xl">222+</div>
                                    <div class="stat-desc text-center text-2xl text-primary">Feedbacks</div>
                                </div>
                            </div>
                        </div>
                        <div class="stats w-full shadow-md">
                            <div class="stat py-14 flex justify-between">
                                ...
                                <button class="btn btn-warning hover:bg-yellow-500 text-white font-bold">Request For Quote</button>
                            </div>
